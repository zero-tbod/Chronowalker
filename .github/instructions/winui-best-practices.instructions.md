...
| `REGDB_E_CLASSNOTREG` error | Verify `<WindowsAppSDKSelfContained>true</WindowsAppSDKSelfContained>` and rebuild the unpackaged app |
...
Build and launch the unpackaged app -- see **Build, Run & Deploy** in `AGENTS.md`.
